    ...
    if(selectedAcc != null){
        ...
        if(!val){
            ...
            setOverlayContent(
                ...
                `Nous n'avons pas pu actualiser la connexion pour <strong>${selectedAcc.displayName}</strong>. Merci de ${accLen > 0 ? 'sélectionnez un autre compte ou ' : ''} reconnectez-vous.`,
                'Connexion',
